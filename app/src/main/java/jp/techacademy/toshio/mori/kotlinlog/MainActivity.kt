...
/*
        ...
        num = 1 //事前にvar num の　定義が残っている場合は、エラーがでるので　var　を削除する。
        ...
        var points = arrayOf(10,6,15,23,17)
    ...
    // firstとlast、２つの引数と戻り値の型(int)を指定した関数に修正
...
*/
/*
     val dog = Dog("ポチ", 3)     // 名前をポチ、年齢3歳で、Dogのインスタンスを作る 2022.1.16
...
/*
        ...
        val bigdog = BigDog("ヨーゼフ", 15)    // 名前をヨーゼフ、年齢15歳で、BigDogのインスタンスを作成
...
*/
        ...
        val human = Human("トシ", 55, "ゴルフ")     //名前をトシ、年齢55歳でHumanのインスタンスを作る
        val human2 = Human("ユキ",10,"ベースボール")
